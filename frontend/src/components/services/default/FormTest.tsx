...
export default function FormTest(): ReactElement {
    ...
    function handleOpenScreen1(e : MouseEvent<HTMLButtonElement>) {
      ...
      setTimeline(
        animate.openFoldAnimate(timeline)
      );
    }
    ...
    function handleOpenScreen2(e : MouseEvent<HTMLButtonElement>) {
      ...
      setTimeline(
        animate.openFoldAnimate(timeline, "#form_test")
      );
    }
      ...
      <div>
        ...
        <div id="form_test" className="w-full h-screen bg-gradient-to-tr from-cyan-400 to-cyan-700">
          <form className="animate_form">
            ...
            <div className="grid">
              <button className="btn btn-primary" onClick={handleOpenScreen1}>테스트</button>
            </div>
            <div className="grid">
              <button className="btn btn-primary" onClick={handleOpenScreen2}>테스트2</button>
            </div>
          </form>
