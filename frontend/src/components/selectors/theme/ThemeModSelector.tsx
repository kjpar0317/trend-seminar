...
export default function ThemeModSelector(): ReactElement {
  const { themePattern, setThemePattern }: IThemeStore = useTheme();
  ...
  return (
    <div
      title="Change Theme"
      className="dropdown dropdown-end hidden [@supports(color:oklch(0_0_0))]:block "
    >
      ...
      <div
        tabIndex={0}
        className="z-[9999] dropdown-content bg-base-200 text-base-content rounded-box top-px h-[28.6rem] max-h-[calc(100vh-10rem)] w-56 overflow-y-auto border border-white/5 shadow-2xl outline outline-1 outline-black/5 mt-16"
      >
