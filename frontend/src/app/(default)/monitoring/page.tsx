...
export default function Monitoring() {
    ...
    function handleClick(selector: string) {
        animate.bounceAnimate?.(`div ${selector}`, "card ring ring-red-500 bg-base-100 h-full z-[9000]");
    }

    return (
        <>
            <div className="w-full space-x-2">
                <button className="btn btn-primary" onClick={() => handleClick(".test1")}>Test1</button>
                <button className="btn btn-primary" onClick={() => handleClick(".test2")}>Test2</button>
                <button className="btn btn-primary" onClick={() => handleClick(".test3")}>Test3</button>
            </div>
